...
This Framework-owned module contains the unchanged Lucas/Pratt-style certificates for the two
published prime constants fixed by the Bitcoin problem.  It also exposes the base-field and
