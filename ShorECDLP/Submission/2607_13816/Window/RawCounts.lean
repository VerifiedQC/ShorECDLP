...
private theorem core_counts (x y : Nat → Nat) :
    (signedRawPrimitives x y).toffoli=79611126 ∧
    (signedRawPrimitives x y).phase=0 ∧ (signedRawPrimitives x y).measurements=23545758 := by
...
private theorem schedule_counts (x y : Nat → Nat → Nat) (js : List Nat) :
    (rawSchedulePrimitives x y js).toffoli=js.length*79611126 ∧
    (rawSchedulePrimitives x y js).phase=0 ∧
    (rawSchedulePrimitives x y js).measurements=js.length*23545758 := by
  induction js with
...
private theorem trial_counts (Q : Point) :
    (preparedRawTrialPrimitives Q).toffoli=2229177063 ∧
    (preparedRawTrialPrimitives Q).phase=54168 ∧
    (preparedRawTrialPrimitives Q).measurements=659347223 := by
...
theorem preparedRawTrial_counts (Q : Point) :
    (primitiveResources (preparedRawTrial Q)).toffoli=2229177063 ∧
    (primitiveResources (preparedRawTrial Q)).phase=54168 ∧
    (preparedRawTrial Q).measurementCount=659347223 :=
...
private theorem repeat_counts (r : PrimitiveResources) (n : Nat)
    (h : r.toffoli=2229177063 ∧ r.phase=54168 ∧ r.measurements=659347223) :
    (scalePrimitives 56 (r.add ⟨0,0,0,0,0,n⟩)).toffoli=124833915528 ∧
    (scalePrimitives 56 (r.add ⟨0,0,0,0,0,n⟩)).phase=3033408 ∧
    (scalePrimitives 56 (r.add ⟨0,0,0,0,0,n⟩)).measurements=56*(659347223+n) := by
...
theorem rawRepeatedProgram_counts (Q : Point) :
    (primitiveResources (rawRepeatedProgram Q)).toffoli=124833915528 ∧
    (primitiveResources (rawRepeatedProgram Q)).phase=3033408 ∧
    (rawRepeatedProgram Q).measurementCount=56*(659347223+(rawTrialResetWires Q).length) :=
...
theorem rawRepeatedProgram_resource_bounds (Q : Point) :
    ...
    (rawRepeatedProgram Q).tCount≤873840442104 ∧
    (rawRepeatedProgram Q).measurementCount≤36923517456 := by
...
theorem rawRepeatedProgram_success_resources (Q : Point)
    ...
    (rawRepeatedProgram Q).qubitCount≤1303 ∧
    (rawRepeatedProgram Q).tCount≤873840442104 ∧
    (rawRepeatedProgram Q).measurementCount≤36923517456 ∧
